        ...
        starlightSidebarTopics([
          {
            ...
            items: [
              'geostix',
              { label: 'Getting started', translations: { fr: 'Pour commencer' }, items: ['geostix/quick_guide', 'geostix/leds', 'geostix/power-toggle', 'geostix/communication', 'geostix/geostix-x5'] },
